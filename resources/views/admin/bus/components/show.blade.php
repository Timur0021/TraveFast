  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">{{ $bus->name_bus }}</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('admin.city.index') }}">Назад</a></li>
              <li class="breadcrumb-item active">Редагування транспорта</li>
            </ol>
          </div>
            ...
            <table class="table table-hover text-nowrap">
              <tbody>
                ...
                <button class=" col-1 btn btn-info">
                  <a href="{{ route('admin.bus.components.edit', $bus->id) }}">
                    <i class="fas fa-pencil-alt" style="color: #000000;"></i></a>
                </button> 
                <form action="{{ route('admin.bus.components.delete', $bus->id) }}" method="POST">
                  @csrf
                  @method('delete')
