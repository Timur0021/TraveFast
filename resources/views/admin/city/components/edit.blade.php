  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Редагувати Місто</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <form action="{{ route('admin.city.components.update', $city->id) }}" method="POST">
      @csrf 
      @method('patch')
      <div class="w-100"></div>
      <div class="mb-3 col-10">
          <label for="name_city" class="form-label">Назва Міста</label>
          <input name="name_city" type="text" class="form-control" id="name_city" value="{{ $city->name_city }}">
          @error('name_city')
