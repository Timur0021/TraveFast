  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Редагувати групу</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <form action="{{ route('admin.group.components.update', $group->id) }}" method="POST">
      @csrf 
      @method('patch')
      <div class="w-100"></div>
      <div class="mb-3 col-10">
          <label for="name_group" class="form-label">Назва Групи</label>
          <input name="name_group" type="text" class="form-control" id="name_group" value="{{ $group->name_group }}">
          @error('name_group')
