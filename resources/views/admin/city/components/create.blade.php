...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <form action="{{ route('admin.city.components.store') }}" method="POST">
      @csrf 
      <div class="w-100"></div>
      <div class="mb-3 col-10">
          <label for="name_city" class="form-label">Назва Міста</label>
          <input name="name_city" type="text" class="form-control" id="name_city" placeholder="Назва міста...">
          @error('name_city')
