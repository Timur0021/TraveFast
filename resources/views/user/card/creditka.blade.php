...
<body>
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-5">Картки</h1>
          <a href="{{ route('user.card.components.create') }}">
    ...
    <div class="card-body table-responsive" style="padding: 5rem;">
        <table class="table table-hover text-nowrap" style="background-color: whitesmoke;">
          ...
          <tbody>
            @foreach ($creditka as $creditkas)
            <tr>
                <td>{{$creditkas->id}}</td>
                <td>{{$creditkas->number}}</td>
                <td>{{$creditkas->balance}}</td>
                <td>{{$creditkas->cvc}}</td>
                <td>{{$creditkas->data}}</td>
                <td><a href="{{ route('user.card.components.show', $creditkas->id) }}"><i class="far fa-eye" style="color: #000000;"></i></a></td>
            </tr>
            @endforeach
          </tbody>
        </table>
