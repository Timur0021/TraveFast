<footer class="travel-footer" data-aos="fade-up">
    <div class="container">
        <div class="row footer-widget-area">
            <div class="col-md-3">
                <a href="index.html" class="footer-brand-wrapper">
                    <img src="{{ asset('assets/images/logo/logos.png') }}" alt="travelist logo">
                </a>
                <p class="contact-details">hello@travelist.com</p>
        ...
        <div class="footer-bottom-content">
            ...
            <p class="mb-0">© Travelist. 2020 <a href="#" target="_blank" rel="noopener noreferrer" class="text-reset">bootstrapdash</a> . All rights reserved.</p>
        </div>
    </div>
</footer>