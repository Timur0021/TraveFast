...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <form action="{{ route('admin.themecite.components.store') }}" method="POST" enctype="multipart/form-data">
      @csrf 
      <div class="w-100"></div>
      <div class="mb-3 col-10">
          <label for="title" class="form-label">Назва Теми</label>
          <input name="title" type="text" class="form-control" id="title" placeholder="Назва міста...">
          @error('title')
