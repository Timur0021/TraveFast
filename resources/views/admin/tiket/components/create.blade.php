...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <form action="{{ route('admin.tiket.components.store') }}" method="POST" enctype="multipart/form-data">
      @csrf 
        <div class="w-100"></div>
        <div class="mb-3 col-10">
          <label for="title" class="form-label">Тип квитка</label>
          <input name="title" type="text" class="form-control" id="title" placeholder="Назва Квитка...">
          @error('title')
        ...
        <div class="w-100"></div>
        <div class="mb-3 col-10">
          <label for="price" class="form-label">Тип квитка</label>
          <input name="price" type="text" class="form-control" id="price" placeholder="Ціна Квитка...">
          @error('price')
              <div class="text-danger">Це поле необхідно заповнити {{ $message }}</div>
          @enderror
        </div>
        ...
        <div class="wb-3 col-10">
            ...
            <select name="bus_id" class="form-control">
                ...
                <option value="{{ $buses->id }}">{{ $buses->name_bus }}</option>
                @endforeach
            </select>
        </div>
        <div class="w-100"></div>
        <div class="wb-3 col-10">
            ...
            <select name="city_id" class="form-control">
                ...
                <option value="{{ $cities->id }}">{{ $cities->name_city }}</option>
                @endforeach
            </select>
        </div>
        <div class="w-100"></div>
