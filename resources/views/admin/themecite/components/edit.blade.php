  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Редагувати Тему</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('admin.city.index') }}">Головна</a></li>
              <li class="breadcrumb-item active">Теми сайту</li>
            </ol>
          </div>
        </div>
      </div>
    </div>
    <form action="{{ route('admin.themecite.components.update', $theme->id) }}" method="POST" enctype="multipart/form-data">
      @csrf 
      @method('patch')
      <div class="w-100"></div>
      <div class="mb-3 col-10">
          <label for="title" class="form-label">Назва Теми</label>
          <input name="title" type="text" class="form-control" id="title" value="{{ $theme->title }}">
          @error('title')
      ...
      <div class="w-100"></div>
        <div class="mb-3 col-10">
            <label for="exampleInputFile">Фото Теми</label>
            <div class="w-50">
                <img src="{{ url('storage/' . $theme->image) }}" class="w-50 mb-3">
            </div>
